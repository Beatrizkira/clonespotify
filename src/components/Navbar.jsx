...
const Navbar = () => {
    ...
    return(
        ...
        <div className="flex items-center gap-2 mt-4">
            <p className="bg-white text-black px-4 py-1 rounded-2x1">All</p>
            <p className="bg-black px-4 py-1 rounded-2x1 ">Music</p>
             <p className="bg-black px-4  py-1 rounded-2x1 ">Podcasts</p>
